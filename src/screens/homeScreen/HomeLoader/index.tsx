...
export function HomeLoader() {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} style={{ backgroundColor: isDark ? appColors.darkPrimary : appColors.lightGray }}>
      ...
      >
        ...
        >
          <ContentLoader speed={2} width={"100%"} height={windowHeight(30)} backgroundColor={isDark ? appColors.darkPrimary : appColors.loaderBackground} foregroundColor={isDark ? appColors.darkPrimary : appColors.loaderLightHighlight}>
